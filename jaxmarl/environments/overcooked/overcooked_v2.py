...
class Overcooked(MultiAgentEnv):
    ...
    def get_obs(self, state: State) -> Dict[str, chex.Array]:
        ...
        for dish_type, (num_onion, num_tomato) in enumerate([(1, 0), (2, 0), (3, 0), (0, 1), (0, 2), (0, 3), (1, 1), (2, 1), (1, 2)]):
            ...
            tomatoes_in_soup_layer += (jnp.sum(agent_inv_items,0) == OBJECT_TO_INDEX[f"dish_{dish_type}"]) * num_tomato * jnp.sum(agent_pos_layers,0)
    ...
    def process_interact(
        ...
        object_to_reward = object_to_reward.at[lookup_reward[:, 0]].set(lookup_reward[:, 1])
